...
A range in index position takes a subsequence: `xs[1..3]`, `xs[..k]`, `xs[k..]`, `xs[..]`, `xs[a..=b]`. Bounds clamp rather than panic. A `String` slice takes byte offsets and snaps to codepoint boundaries.

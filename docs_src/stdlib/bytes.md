...
|---|---|---|
| [`Buffer`](https://github.com/danpozmanter/gossamer/blob/main/crates/gossamer-std/src/bytes.rs) | `type` — see the source declaration | Growable byte buffer. |
| [`Builder`](https://github.com/danpozmanter/gossamer/blob/main/crates/gossamer-std/src/bytes.rs) | `type` — see the source declaration | Incremental string builder. |

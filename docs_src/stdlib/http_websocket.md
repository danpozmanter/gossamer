...
| [`accept`](https://github.com/gossamer-lang/gossamer/blob/main/crates/gossamer-std/src/http_websocket.rs) | `fn accept(request: http::Request) -> Result<http::websocket::Conn, errors::Error>` | Upgrade an incoming Request to a WebSocket (Rust-side). |

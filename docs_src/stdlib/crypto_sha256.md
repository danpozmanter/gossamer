...
|---|---|---|
| [`digest`](https://github.com/danpozmanter/gossamer/blob/main/crates/gossamer-std/src/crypto.rs) | `fn digest(data: Vec<u8>) -> Vec<u8>` | Returns the 32-byte digest of an input. |

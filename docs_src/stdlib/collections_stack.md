...
| [`peek`](https://github.com/gossamer-lang/gossamer/blob/main/crates/gossamer-std/src/container_seq.rs) | `fn peek(xs: Vec<i64>) -> Option<i64>` | Top element, if present. |
| [`pop`](https://github.com/gossamer-lang/gossamer/blob/main/crates/gossamer-std/src/container_seq.rs) | `fn pop(xs: Vec<i64>) -> Vec<i64>` | Drop the top; returns the new stack. |
| [`push`](https://github.com/gossamer-lang/gossamer/blob/main/crates/gossamer-std/src/container_seq.rs) | `fn push(xs: Vec<i64>, value: i64) -> Vec<i64>` | Push an i64 onto the top; returns the new stack. |

...
| Collections | `Vec<T>`, `HashMap<K, V>`, `HashSet<T>`, `BTreeSet<T>`, `BTreeMap<String, i64>`, `VecDeque<i64>`, `VecQueue<i64>`, `VecDequeue<i64>`, `MaxHeap<i64>`, `MinHeap<i64>`, `BinaryHeap<i64>`, `Range` | Core collection types. |

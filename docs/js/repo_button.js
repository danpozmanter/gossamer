// Injects a prominent fixed-position GitHub button at the top-right
// of every docs page. The readthedocs theme only puts the repo
// link in the sidebar header, which is easy to miss; this lifts it
// to a primary call-to-action so the source repo is always one
// click away.
(function () {
    function inject() {

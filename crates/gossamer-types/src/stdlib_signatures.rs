...
pub const STD_FUNCTION_SIGNATURES: &[StdFunctionSignature] = &[
    ...
    StdFunctionSignature {
        ...
        name: "len",
        signature: "fn len(xs: Deque<i64>) -> i64",
    },
    StdFunctionSignature {
        module_path: "std::collections::deque",
        name: "peek_back",
        signature: "fn peek_back(xs: Deque<i64>) -> i64",
    },
    StdFunctionSignature {
        module_path: "std::collections::deque",
        name: "peek_front",
        signature: "fn peek_front(xs: Deque<i64>) -> i64",
    },
    StdFunctionSignature {
        module_path: "std::collections::deque",
        name: "pop_back",
        signature: "fn pop_back(xs: Deque<i64>) -> Deque<i64>",
    },
    StdFunctionSignature {
        module_path: "std::collections::deque",
        name: "pop_front",
        signature: "fn pop_front(xs: Deque<i64>) -> Deque<i64>",
    },
    StdFunctionSignature {
        module_path: "std::collections::deque",
        name: "push_back",
        signature: "fn push_back(xs: Deque<i64>, value: i64) -> Deque<i64>",
    },
    StdFunctionSignature {
        module_path: "std::collections::deque",
        name: "push_front",
        signature: "fn push_front(xs: Deque<i64>, value: i64) -> Deque<i64>",
    },
    StdFunctionSignature {
        module_path: "std::collections::heap",
        name: "len",
        signature: "fn len(xs: Heap<i64>) -> i64",
    },
    StdFunctionSignature {
        module_path: "std::collections::heap",
        name: "peek",
        signature: "fn peek(xs: Heap<i64>) -> i64",
    },
    StdFunctionSignature {
        module_path: "std::collections::heap",
        name: "pop",
        signature: "fn pop(xs: Heap<i64>) -> Heap<i64>",
    },
    StdFunctionSignature {
        module_path: "std::collections::heap",
        name: "push",
        signature: "fn push(xs: Heap<i64>, value: i64) -> Heap<i64>",
    },
    StdFunctionSignature {
        module_path: "std::collections::ordered_map",
        name: "contains_key",
        signature: "fn contains_key(map: OrderedMap<String, i64>, key: String) -> bool",
    },
    StdFunctionSignature {
        module_path: "std::collections::ordered_map",
        name: "get",
        signature: "fn get(map: OrderedMap<String, i64>, key: String) -> Option<i64>",
    },
    StdFunctionSignature {
        module_path: "std::collections::ordered_map",
        name: "insert",
        signature: "fn insert(map: OrderedMap<String, i64>, key: String, value: i64) -> OrderedMap<String, i64>",
    },
    StdFunctionSignature {
        module_path: "std::collections::ordered_map",
        name: "len",
        signature: "fn len(map: OrderedMap<String, i64>) -> i64",
    },
    StdFunctionSignature {
        module_path: "std::collections::ordered_map",
        name: "remove",
        signature: "fn remove(map: OrderedMap<String, i64>, key: String) -> OrderedMap<String, i64>",
    },
    StdFunctionSignature {
        module_path: "std::collections::ordered_set",
        name: "contains",
        signature: "fn contains(xs: OrderedSet<i64>, value: i64) -> bool",
    },
    StdFunctionSignature {
        module_path: "std::collections::ordered_set",
        name: "insert",
        signature: "fn insert(xs: OrderedSet<i64>, value: i64) -> OrderedSet<i64>",
    },
    StdFunctionSignature {
        module_path: "std::collections::ordered_set",
        name: "len",
        signature: "fn len(xs: OrderedSet<i64>) -> i64",
    },
    StdFunctionSignature {
        module_path: "std::collections::ordered_set",
        name: "remove",
        signature: "fn remove(xs: OrderedSet<i64>, value: i64) -> OrderedSet<i64>",
    },
    StdFunctionSignature {
    ...
    StdFunctionSignature {
        module_path: "std::collections::ordered_vec",
        name: "peek_max",
        signature: "fn peek_max(xs: Vec<i64>) -> i64",
    },
    StdFunctionSignature {
        module_path: "std::collections::ordered_vec",
        name: "peek_min",
        signature: "fn peek_min(xs: Vec<i64>) -> i64",
    },
    StdFunctionSignature {
        module_path: "std::collections::ordered_vec",
        name: "remove_at",
    ...
    StdFunctionSignature {
        ...
        name: "len",
        signature: "fn len(xs: Queue<i64>) -> i64",
    },
    StdFunctionSignature {
        module_path: "std::collections::queue",
        name: "peek",
        signature: "fn peek(xs: Queue<i64>) -> i64",
    },
    StdFunctionSignature {
        module_path: "std::collections::queue",
        name: "pop",
        signature: "fn pop(xs: Queue<i64>) -> Queue<i64>",
    },
    StdFunctionSignature {
        module_path: "std::collections::queue",
        name: "push",
        signature: "fn push(xs: Queue<i64>, value: i64) -> Queue<i64>",
    },
    StdFunctionSignature {
        module_path: "std::collections::stack",
        name: "len",
        signature: "fn len(xs: Stack<i64>) -> i64",
    },
    StdFunctionSignature {
        module_path: "std::collections::stack",
        name: "peek",
        signature: "fn peek(xs: Stack<i64>) -> i64",
    },
    StdFunctionSignature {
        module_path: "std::collections::stack",
        name: "pop",
        signature: "fn pop(xs: Stack<i64>) -> Stack<i64>",
    },
    StdFunctionSignature {
        module_path: "std::collections::stack",
        name: "push",
        signature: "fn push(xs: Stack<i64>, value: i64) -> Stack<i64>",
    },
    StdFunctionSignature {
    ...
    StdFunctionSignature {
        module_path: "std::strings",
        name: "chars",
        signature: "fn chars(text: String) -> Vec<char>",
    },
    StdFunctionSignature {
        module_path: "std::strings",
        name: "contains",

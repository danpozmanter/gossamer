...
pub use checker::{
    is_array_sequence_method, is_iterator_method, is_map_method, is_slice_sequence_method,
    is_tuple_method, is_tuple_rejected_method, is_vec_only_sequence_method,
    iterator_adapter_is_lazy, typecheck_source_file, typecheck_source_file_for_repl_inspection,

...
pub(super) fn lower_generic_rt_call(
    ...
    let (params, ret): (&[ir::Type], Option<ir::Type>) = match name {
        ...
        "gos_rt_vec_swap_safe" => (&[ptr_ty, types::I64, types::I64], None),
        ...
        "gos_rt_deque_new" | "gos_rt_queue_new" | "gos_rt_stack_new" => (&[], Some(ptr_ty)),
        ...
        "gos_rt_shared_new" => (&[types::I64], Some(ptr_ty)),
        "gos_rt_shared_get" => (&[ptr_ty], Some(types::I64)),
        "gos_rt_shared_set" => (&[ptr_ty, types::I64], None),
        "gos_rt_shared_with" => (&[ptr_ty, ptr_ty], Some(types::I64)),
        "gos_rt_shared_update" => (&[ptr_ty, ptr_ty], Some(types::I64)),
        ...
        "gos_rt_option_unwrap" | "gos_rt_result_unwrap" => (&[types::I128], Some(types::I64)),
        ...
        "gos_rt_iter_max_by_key_f64" => (&[ptr_ty, ptr_ty, types::I64], Some(types::I128)),
        "gos_rt_iter_max_by_key_i64" => (&[ptr_ty, ptr_ty, types::I64], Some(types::I128)),
        "gos_rt_iter_max_by_key_ptr" => (&[ptr_ty, ptr_ty, types::I64], Some(types::I128)),
        "gos_rt_iter_min_by_i64" => (&[ptr_ty, ptr_ty], Some(types::I128)),
        "gos_rt_iter_min_by_key_f64" => (&[ptr_ty, ptr_ty, types::I64], Some(types::I128)),
        "gos_rt_iter_min_by_key_i64" => (&[ptr_ty, ptr_ty, types::I64], Some(types::I128)),
        "gos_rt_iter_min_by_key_ptr" => (&[ptr_ty, ptr_ty, types::I64], Some(types::I128)),
        ...
        "gos_rt_iter_sorted_by_key_f64" => (&[ptr_ty, ptr_ty, types::I64], Some(ptr_ty)),
        "gos_rt_iter_sorted_by_key_i64" => (&[ptr_ty, ptr_ty, types::I64], Some(ptr_ty)),
        ...
        "gos_rt_arr_sort_by_f64" => (&[ptr_ty, types::I64, ptr_ty], None),
        "gos_rt_arr_sort_by_i64" => (&[ptr_ty, types::I64, ptr_ty], None),
        "gos_rt_vec_sort_by_f64" => (&[ptr_ty, ptr_ty], None),
        ...
        "gos_rt_json_free" => (&[ptr_ty], None),
        "gos_rt_json_set" => (&[ptr_ty, ptr_ty, ptr_ty], Some(ptr_ty)),
        "gos_rt_lazy_iter_all_f64" => (&[ptr_ty, ptr_ty], Some(types::I64)),
        "gos_rt_lazy_iter_any_f64" => (&[ptr_ty, ptr_ty], Some(types::I64)),
        "gos_rt_lazy_iter_filter_f64" => (&[ptr_ty, ptr_ty], Some(ptr_ty)),
        "gos_rt_lazy_iter_find_f64" => (&[ptr_ty, ptr_ty], Some(types::I128)),
        "gos_rt_lazy_iter_fold_f64" => (&[types::F64, ptr_ty, ptr_ty], Some(types::F64)),
        "gos_rt_lazy_iter_fold_f64_word" => (&[types::F64, ptr_ty, ptr_ty], Some(types::F64)),
        "gos_rt_lazy_iter_fold_word_f64" => (&[types::I64, ptr_ty, ptr_ty], Some(types::I64)),
        "gos_rt_lazy_iter_from_vec_f64" => (&[ptr_ty], Some(ptr_ty)),
        "gos_rt_lazy_iter_map_f64" => (&[ptr_ty, ptr_ty], Some(ptr_ty)),
        "gos_rt_lazy_iter_map_f64_word" => (&[ptr_ty, ptr_ty], Some(ptr_ty)),
        "gos_rt_lazy_iter_map_word_f64" => (&[ptr_ty, ptr_ty], Some(ptr_ty)),
        "gos_rt_lazy_iter_max_f64" => (&[ptr_ty], Some(types::I128)),
        "gos_rt_lazy_iter_min_f64" => (&[ptr_ty], Some(types::I128)),
        "gos_rt_lazy_iter_next_f64" => (&[ptr_ty], Some(types::I128)),
        "gos_rt_lazy_iter_once_f64" => (&[types::F64], Some(ptr_ty)),
        "gos_rt_lazy_iter_product_f64" => (&[ptr_ty], Some(types::F64)),
        "gos_rt_lazy_iter_repeat_f64" => (&[types::F64, types::I64], Some(ptr_ty)),
        "gos_rt_lazy_iter_step_by_i64" => (&[types::I64, ptr_ty], Some(ptr_ty)),
        "gos_rt_lazy_iter_str_bytes" => (&[ptr_ty], Some(ptr_ty)),
        "gos_rt_lazy_iter_str_chars" => (&[ptr_ty], Some(ptr_ty)),

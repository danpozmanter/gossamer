...
fn register_runtime_symbols(builder: &mut JITBuilder) -> std::collections::HashSet<&'static str> {
    ...
    reg! {
        ...
        "gos_rt_sandbox_policy_network_mode" => rt::gos_rt_sandbox_policy_network_mode,
        "gos_rt_sandbox_policy_for_fetch_phase" => rt::gos_rt_sandbox_policy_for_fetch_phase,
        "gos_rt_sandbox_policy_read_only_cwd" => rt::gos_rt_sandbox_policy_read_only_cwd,
        "gos_rt_sandbox_policy_temp" => rt::gos_rt_sandbox_policy_temp,
        "gos_rt_sandbox_policy_temp_path" => rt::gos_rt_sandbox_policy_temp_path,
        "gos_rt_sandbox_policy_max_processes" => rt::gos_rt_sandbox_policy_max_processes,
        "gos_rt_sandbox_policy_max_memory" => rt::gos_rt_sandbox_policy_max_memory,
        "gos_rt_sandbox_policy_max_cpu_time" => rt::gos_rt_sandbox_policy_max_cpu_time,
        "gos_rt_sandbox_policy_max_file_size" => rt::gos_rt_sandbox_policy_max_file_size,
        "gos_rt_sandbox_policy_max_temp_size" => rt::gos_rt_sandbox_policy_max_temp_size,
        "gos_rt_sandbox_policy_check" => rt::gos_rt_sandbox_policy_check,
        "gos_rt_sandbox_policy_mechanisms" => rt::gos_rt_sandbox_policy_mechanisms,
        "gos_rt_sandbox_policy_to_json" => rt::gos_rt_sandbox_policy_to_json,
        "gos_rt_sandbox_policy_access" => rt::gos_rt_sandbox_policy_access,
        "gos_rt_sandbox_policy_read_write_grants" => rt::gos_rt_sandbox_policy_read_write_grants,
        "gos_rt_sandbox_policy_read_only_grants" => rt::gos_rt_sandbox_policy_read_only_grants,
        "gos_rt_sandbox_policy_denials" => rt::gos_rt_sandbox_policy_denials,
        "gos_rt_sandbox_policy_environment_names" => rt::gos_rt_sandbox_policy_environment_names,
        "gos_rt_sandbox_policy_environment_value" => rt::gos_rt_sandbox_policy_environment_value,
        "gos_rt_sandbox_policy_level_name" => rt::gos_rt_sandbox_policy_level_name,
        "gos_rt_sandbox_policy_network_name" => rt::gos_rt_sandbox_policy_network_name,
        "gos_rt_sandbox_policy_working_directory_path" => rt::gos_rt_sandbox_policy_working_directory_path,
        "gos_rt_sandbox_policy_level_blocker" => rt::gos_rt_sandbox_policy_level_blocker,
        "gos_rt_sandbox_policy_network_enforcement_kind" => rt::gos_rt_sandbox_policy_network_enforcement_kind,
        "gos_rt_sandbox_policy_network_enforcement_reason" => rt::gos_rt_sandbox_policy_network_enforcement_reason,
        "gos_rt_sandbox_policy_resource_enforcement_kind" => rt::gos_rt_sandbox_policy_resource_enforcement_kind,
        "gos_rt_sandbox_policy_resource_enforcement_reason" => rt::gos_rt_sandbox_policy_resource_enforcement_reason,
        "gos_rt_sandbox_os_description" => rt::gos_rt_sandbox_os_description,
        "gos_rt_sandbox_filesystem_kind" => rt::gos_rt_sandbox_filesystem_kind,
        "gos_rt_sandbox_filesystem_reason" => rt::gos_rt_sandbox_filesystem_reason,
        "gos_rt_sandbox_network_kind" => rt::gos_rt_sandbox_network_kind,
        "gos_rt_sandbox_network_reason" => rt::gos_rt_sandbox_network_reason,
        ...
        "gos_rt_sandbox_resource_limits_kind" => rt::gos_rt_sandbox_resource_limits_kind,
        "gos_rt_sandbox_resource_limits_reason" => rt::gos_rt_sandbox_resource_limits_reason,
        ...
        "gos_rt_sandbox_home_directory" => rt::gos_rt_sandbox_home_directory,
        "gos_rt_sandbox_rust_toolchain_paths" => rt::gos_rt_sandbox_rust_toolchain_paths,
        "gos_rt_sandbox_stale_grant_count" => rt::gos_rt_sandbox_stale_grant_count,
        "gos_rt_sandbox_clean_stale_grants" => rt::gos_rt_sandbox_clean_stale_grants,
        "gos_rt_sandbox_exit_policy_error" => rt::gos_rt_sandbox_exit_policy_error,
        "gos_rt_sandbox_exit_command_not_found" => rt::gos_rt_sandbox_exit_command_not_found,
        "gos_rt_sandbox_exit_level_unavailable" => rt::gos_rt_sandbox_exit_level_unavailable,
        "gos_rt_sandbox_exit_signal_base" => rt::gos_rt_sandbox_exit_signal_base,
        "gos_rt_sandbox_run_inherit" => rt::gos_rt_sandbox_run_inherit,
